package college.performance.util;
...
public class GeneratorUtil {
    ...
    private static final String URL = "jdbc:mysql://43.143.47.137:3306/performance?useUnicode=true&characterEncoding=utf-8&useSSL=false";
    ...
    private static GlobalConfig getGlobalConfig() {
        ...
        try {
            globalConfig.setOpen(false)
                    ...
                    .setOutputDir(new File("Performance").getCanonicalFile().getParentFile().getPath()+"/src/main/java")
                    //生成文件的输出目录
...
//                    .setServiceImplName("%sServiceImpl")
    ...
    private static PackageConfig getPackageConfig() {
        ...
        //不同模块 代码生成具体路径自定义指定
        String basePackage = "college.performance";
